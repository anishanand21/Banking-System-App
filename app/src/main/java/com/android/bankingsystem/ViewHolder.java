...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.android.bankingsystem.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.android.bankingsystem.ViewHolder.ClickListener clickListener){
